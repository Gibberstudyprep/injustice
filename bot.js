...
// Powered by Claude AI + Google Sheets + Wiki Search
// ============================================================
...
if (data.error) {
  ...
  const reply = data.content
    ...
    .join("\n")
    .trim() || "I couldn't find a good answer for that. Try asking differently!";
...
app.get("/test", async (req, res) => {
  ...
  const reply = await askClaude(q, "test-user");
